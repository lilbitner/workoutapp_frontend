const aboutCard = document.createElement('div')
    ...
    <h1 id='euphoria'>Euphoria is a platform to consolidate exercise goals into one easy to use webpage, with personally developed workouts created based on your goals and local weather forecast.<h1>
    </div>
